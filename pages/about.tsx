...
export default function About() {
	return (
		<Page meta={aboutMeta} title="هادي البن سعد 🤾🏻‍♂️"
			...
			<Section title="ودك تاخذ لفة على الcv؟ 📜️">
				<span>لنكدان فيه كل شيء بس اذا ملزم 👀</span>

				<div style={{ width: '8px', height: '8px', display: 'inline-block' }}/>

				<a href={'/cv.pdf'} target="_blank" rel="noopener noreferrer" className="hoverable">
					حمله من هنا
				</a>
			</Section>
